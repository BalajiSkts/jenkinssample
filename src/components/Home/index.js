                ...
                <Fade>
                  <div className="card p-3">
                    ...
                    <div className="row" style={{ marginTop: 25 }}>
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">Residence City</label>
                        <input
                          onKeyDown={handleKeyPress}
                          maxLength={30}
                          id="residency-city"
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">Residence State</label>
                        <input
                          onKeyDown={handleKeyPress}
                          maxLength={30}
                          required
                    ...
                    <div className="row">
                      ...
                      <div className="row" style={{ marginTop: "-30px" }}>
                        ...
                        <div className="col-sm-7">
                          <label className="label-txt">
                            Weight in KG{" "}
                            <span>(closest to the date of HCC diagnosis)</span>
                          </label>
                          <input
                            onKeyDown={handleKeyPress}
                            placeholder="Weight"
                      ...
                      <div className="col-sm-12">
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td className="col-sm-5">
                                <span>Alanine Aminotransferase(ALT)</span>
                              </td>
                              <td className="col-sm-1">
                                <input
                                  onKeyDown={handleKeyPress}
                ...
                <Fade>
                  <div className="card p-3">
                    <table className="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td className="col-sm-3">Diabetes</td>
                        ...
                        <tr>
                          <td className="col-sm-3">Hypertension</td>
                          <td className="col-sm-1 text-center">
                            <input
                              onKeyDown={handleKeyPress}
                              required
                        ...
                        <tr>
                          <td className="col-sm-3">Dyslipidemia</td>
                          <td className="col-sm-1 text-center">
                            <input
                              onKeyDown={handleKeyPress}
                              required
                        ...
                        <tr>
                          <td className="col-sm-3">Coronary Artery Disease</td>
                          <td className="col-sm-1 text-center">
                            <input
                              onKeyDown={handleKeyPress}
                              required
                        ...
                        <tr>
                          <td className="col-sm-3">Non-liver cancer</td>
                          <td className="col-sm-1 text-center">
                            <input
                              onKeyDown={handleKeyPress}
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Any Method of Screening <br />
                          Found within 2 Years Before HCC diagnosis?
                        </label>
                      </div>
                      <div className="col-sm-8">
                        <input
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          If HIV RNA level is below <br /> limit of detection,
                          (Fill the following)
                        </label>
                      </div>
                      <div
