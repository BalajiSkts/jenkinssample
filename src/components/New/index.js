...
const Reused = () => {
  ...
  const sectionDetails = [
    ...
    },
    {
      key: "section4",
      value:
        "Laboratory Parameters most recent and within 6 months of the HCC diagnosis",
    },
    {
      key: "section5",
      value: "Comorbidities",
  ...
  useEffect(() => {
    ...
    if (onlyData && onlyData?.comments) {
      ...
      if (
        typeof onlyData?.comments === "object" &&
        typeof onlyData?.comments?.comment !== "string"
      )
  ...
  const getStudyPreDetails = () => {
    ...
    fetch(`${apiUrl}/eCRF-rest-service/projects`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
  ...
  const [diagnosisInformationValue, setDiagnosisInformationValue] = useState(
    []
  );
  ...
  const calculatedScores = (type, valid) => {
    let isValid =
      type === "Applicable"
        ? true
        : modelEndStageLab !== "Applicable" && modelEndStageLab !== ""
        ? true
        : false;
    ...
    if (isValid) {
      const calculateMELD = () => {
        ...
        const tmpBilirubinValue =
          bilirubinValue !== "" ? (bilirubinValue < 1 ? 1 : bilirubinValue) : 0;
  ...
  const getAuditOldValue = (data) => {
    if (data.id === 15)
      return onlyData["comments"] && onlyData["comments"]["comment"];
  ...
  const handleAuditDetails = async (data) => {
    if (data.id === 15) {
      ...
      if (oldVal !== data.value) {
        ...
        const aData = auditData.filter(
          (item) => item.fControlName !== data.fControlName
        );
        setAuditData(aData);
      }
    }
  ...
  const updateComments = async () => {
    const section = sectionDetails.find(
      (section) => section.key === commentSection
    );
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" htmlFor="study-title">
                        ...
                        <button
                          ...
                          className={
                            isCommentExist("section1", "studyDate")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                      ...
                      <div className="col-sm-3">
                        <label className="label-txt" htmlFor="subject-counter">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "subjectYear")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-5" style={{ marginTop: 20 }}>
                        <label className="label-txt" htmlFor="gender">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "subjectGender")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-7" style={{ marginTop: 20 }}>
                        <label className="label-txt" htmlFor="gender">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "otherCheck")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                            ...
                            {otherCheck === "Others" && (
                              <>
                                ...
                                <textarea
                                  ...
                                  value={subjectOtherText}
                                  onChange={(e) =>
                                    setSubjectOtherText(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 2,
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "placeOfBirthCity")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "placeOfBirthState")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "residencyCity")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section2", "residencyState")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                    ...
                    <div className="row">
                      <div className="col-sm-3">
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section3", "dateOfHcc")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-3">
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section3", "baseLineIfDateRadio")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                        ...
                        <Form.Check
                          ...
                          checked={
                            baseLineIfDateRadio &&
                            baseLineIfDateRadio.includes("Unknown")
                          }
                      ...
                      <div className="col-sm-5">
                        <label className="label-txt-baseLine">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section3", "baseLineIfDate")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-4" style={{ marginTop: 20 }}>
                        <label className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section3", "baseLineAgeOfHcc")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="row" style={{ marginTop: "-30px" }}>
                        <div className="col-sm-3">
                          <label className="label-txt">
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section3", "baseLineHeight")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                        ...
                        <div className="col-sm-7">
                          <label className="label-txt">
                            Weight in KG{" "}
                            <span>
                              (closest to the date of HCC diagnosis)
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist(
                      ...
                      <div className="row" style={{ marginTop: 20 }}>
                        <div className="col-sm-6">
                          <label className="label-txt">
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section3", "insuranceValue")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                        ...
                        <div className="col-sm-4">
                          ...
                          <textarea
                            onKeyDown={handleKeyPress}
                            disabled={
                              !insuranceValue || role === "ROLE_REVIEWER"
                            }
                            maxLength={200}
            ...
            <div className="study-container">
              <div className="studyData-container">
                <h1 className="study-txt">
                  Laboratory Parameters most recent and within 6 months of the
                  HCC diagnosis{" "}
                </h1>
                <button
                    ...
                    <div className="row">
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  value={hemoGlobinFrom}
                                  onChange={(e) =>
                                    setHemoGlobinFrom(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "hemoGlobinFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setHemoGlobinTo(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "hemoGlobinTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  // value={'sDesign'}
                                  checked={hemoGlobinUnknown?.includes(
                                    "Unknown"
                                  )}
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName:
                                        "Alanine Aminotransferase(ALT) From",
                                      fControlName: "alanineFrom",
                                      value: alanineFrom,
                                    })
                                  }
                                  onChange={(e) =>
                                    setAlanineFrom(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alanineFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alanineTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onBlur={() => {
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName:
                                        "Alanine Aminotransferase(ALT) Value",
                                      fControlName: "alanineValue",
                                      value: alanineValue,
                                    });
                                    calculatedScores(
                                      "NA",
                                      modelEndStageLab === "Not applicable"
                                        ? false
                                        : true
                                    );
                                  }}
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alanineValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                                ...
                                <Form.Check
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName:
                                        "Alanine Aminotransferase(ALT) Unknown",
                                      fControlName: "alanineUnknown",
                                      value: alanineUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (aspartateUnknown &&
                                      aspartateUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setAspartateFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "aspartateFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "aspartateTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "aspartateValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  type="checkbox"
                                  label="Unknown"
                                  checked={aspartateUnknown?.includes(
                                    "Unknown"
                                  )}
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (bilirubinUnknown &&
                                      bilirubinUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setBilirubinFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bilirubinFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bilirubinTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bilirubinValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  type="checkbox"
                                  label="Unknown"
                                  checked={bilirubinUnknown?.includes(
                                    "Unknown"
                                  )}
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (alkalineUnknown &&
                                      alkalineUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setAlkalineFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alkalineFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alkalineTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alkalineValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName: "Albumin From",
                                      fControlName: "albuminFrom",
                                      value: albuminFrom,
                                    })
                                  }
                                  onChange={(e) =>
                                    setAlbuminFrom(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "albuminFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "albuminTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "albuminValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPlatelatesFrom(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "platelatesFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPlatelatesTo(e.target.value)
                                  }
                                  type="text"
                                  className="form-control"
                                />
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "platelatesTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  type="checkbox"
                                  label="Unknown"
                                  checked={platelatesUnknown?.includes(
                                    "Unknown"
                                  )}
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (creatinineUnknown &&
                                      creatinineUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setCreatinineFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "creatinineFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCreatinineTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "creatinineTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                                ...
                                <input
                                  ...
                                  onBlur={() => {
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Creatinine Value",
                                      fControlName: "creatinineValue",
                                      value: creatinineValue,
                                    });
                                    calculatedScores(
                                      "NA",
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={creatinineUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Creatinine Unknown",
                                      fControlName: "creatinineUnknown",
                                      value: creatinineUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (prothrombinUnknown &&
                                      prothrombinUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setProthrombinFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setProthrombinTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "prothrombinTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={prothrombinUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName: "PT Unknown",
                                      fControlName: "prothrombinUnknown",
                                      value: prothrombinUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (internationalUnknown &&
                                      internationalUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setInternationalFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "INR From",
                                      fControlName: "internationalFrom",
                                      value: internationalFrom,
                                    })
                                  }
                                  type="text"
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setinternationalTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <input
                                  ...
                                  onBlur={() => {
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName: "INR Value",
                                      fControlName: "internationalValue",
                                      value: internationalValue,
                                    });
                                    calculatedScores(
                                      "NA",
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={internationalUnknown?.includes(
                                    "Unknown"
                                  )}
                                  onChange={() =>
                                    handleinternational("Unknown")
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "INR Unknown",
                                      fControlName: "internationalUnknown",
                                      value: internationalUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alphaFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alphaTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "alphaValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (sodiumUnknown &&
                                      sodiumUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setSodiumFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "sodiumFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "sodiumTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "sodiumValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                                ...
                                ></button>
                                <p className="alert">
                                  {(parseFloat(sodiumValue) <
                                    parseFloat(sodiumFrom) ||
                                    parseFloat(sodiumValue) >
                                      parseFloat(sodiumTo)) &&
                                    "Not in between the range"}
                                </p>
                                ...
                                <Form.Check
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Sodium Unknown",
                                      fControlName: "sodiumUnknown",
                                      value: sodiumUnknown,
                                    })
                                  }
                                />
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (bloodUreaUnknown &&
                                      bloodUreaUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setBloodUreaFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Blood Urea Nitrogen From",
                                      fControlName: "bloodUreaFrom",
                                      value: bloodUreaFrom,
                                    })
                                  }
                                  type="text"
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bloodUreaFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setBloodUreaTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Blood Urea Nitrogen To",
                                      fControlName: "bloodUreaTo",
                                      value: bloodUreaTo,
                                    })
                                  }
                                  type="text"
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bloodUreaTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Blood Urea Nitrogen Value",
                                      fControlName: "bloodUreaValue",
                                      value: bloodUreaValue,
                                    })
                                  }
                                  type="text"
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "bloodUreaValue")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={bloodUreaUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Blood Urea Nitrogen Unknown",
                                      fControlName: "bloodUreaUnknown",
                                      value: bloodUreaUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (cholesterolUnknown &&
                                      cholesterolUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setCholesterolFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Cholesterol From",
                                      fControlName: "cholesterolFrom",
                                      value: cholesterolFrom,
                                    })
                                  }
                                  type="text"
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCholesterolTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Cholesterol To",
                                      fControlName: "cholesterolTo",
                                      value: cholesterolTo,
                                    })
                                  }
                                  type="text"
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "cholesterolTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                                ...
                                <input
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Cholesterol Value",
                                      fControlName: "cholesterolValue",
                                      value: cholesterolValue,
                                    })
                                  }
                                  type="text"
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={cholesterolUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Cholesterol Unknown",
                                      fControlName: "cholesterolUnknown",
                                      value: cholesterolUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (triglyceridesUnknown &&
                                      triglyceridesUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setTriglyceridesFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Triglycerides From",
                                      fControlName: "triglyceridesFrom",
                                      value: triglyceridesFrom,
                                    })
                                  }
                                  type="text"
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setTriglyceridesTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Triglycerides To",
                                      fControlName: "triglyceridesTo",
                                      value: triglyceridesTo,
                                    })
                                  }
                                  type="text"
                                ...
                                <input
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Triglycerides Value",
                                      fControlName: "triglyceridesValue",
                                      value: triglyceridesValue,
                                    })
                                  }
                                  type="text"
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={triglyceridesUnknown?.includes(
                                    "Unknown"
                                  )}
                                  onChange={() =>
                                    handletriglycerides("Unknown")
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                      name: "Laboratory Parameters",
                                      fName: "Triglycerides Unknown",
                                      fControlName: "triglyceridesUnknown",
                                      value: triglyceridesUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (highDensityUnknown &&
                                      highDensityUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setHighDenistyFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setHighDensityTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "highDensityTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={highDensityUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName: "HDL Unknown",
                                      fControlName: "highDensityUnknown",
                                      value: highDensityUnknown,
                                    })
                                  }
                                />
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  disabled={
                                    (lowDensityUnknown &&
                                      lowDensityUnknown[0] === "Unknown") ||
                                    role === "ROLE_REVIEWER"
                                  }
                                  onChange={(e) =>
                                    setLowDensityFrom(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "lowDensityFrom")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td className="col-sm-1">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setLowDensityTo(e.target.value)
                                  }
                                  onBlur={() =>
                                    handleAuditDetails({
                                      id: 4,
                                ...
                                <button
                                  type="btn btn-primary"
                                  className={
                                    isCommentExist("section4", "lowDensityTo")
                                      ? "cBtn cExists"
                                      : "cBtn cNExists"
                                  }
                                  onClick={(e) =>
                              ...
                              <td>
                                <Form.Check
                                  ...
                                  label="Unknown"
                                  disabled={role === "ROLE_REVIEWER"}
                                  checked={lowDensityUnknown?.includes(
                                    "Unknown"
                                  )}
                                  ...
                                  onBlur={() =>
                                    handleAuditDetails({
                                      ...
                                      name: "Laboratory Parameters",
                                      fName: "LDL Unknown",
                                      fControlName: "lowDensityUnknown",
                                      value: lowDensityUnknown,
                                    })
                                  }
                                />
                              </td>
                      ...
                      <div className="col-sm-12">
                        <label htmlFor="alanine-lab" className="label-txt">
                          Model for End Stage Liver Disease (MELD)Na score for
                          Cirrhosis Patient
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section4", "modelEndStageLab")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "modelEndStageLab",
                                value: modelEndStageLab,
                                section: "section4",
                              })
                            }
                          ></button>
                            ...
                            <Form.Check
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  ...
                                  name: "Laboratory Parameters",
                                  fName:
                                    "Model for End Stage Liver Disease (MELD) Not Applicable",
                                  fControlName: "modelEndStageLab",
                                  value: modelEndStageLab,
                                })
                              }
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={(e) =>
                                  handleComments({
                                    e,
                                    fControlName: "modelEndStageTextArea",
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label htmlFor="alanine-lab" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section4", "meldScoreLab")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-3" style={{ marginTop: 20 }}>
                        <label htmlFor="FIB4-lab" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section4", "fib4Lab")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-6" style={{ marginTop: 20 }}>
                        <label htmlFor="ast-platelet-lab" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section4", "astPlateletLab")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
              ...
              <div className={comorbiditiesButton ? "study-data" : ""}>
                <Fade>
                  <div className="card p-3">
                        ...
                        <tr>
                          <td className="col-sm-3">
                            ...
                            <button
                              ...
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "diabetesComorbidities",
                                  value: diabetesComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <input
                                ...
                                value={"Prior to"}
                                onChange={(e) =>
                                  setDiabetesAfter(e.target.value)
                                }
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Diabetes Prior To",
                                    fControlName: "diabetesAfter",
                                    value: diabetesAfter,
                                  })
                                }
                                type="radio"
                              ...
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist("section5", "diabetesAfter")
                                    ? "cBtn cExists"
                                    : "cBtn cNExists"
                                }
                                onClick={(e) =>
                          ...
                          <td className="col-sm-2">
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Diabetes input",
                                  fControlName: "yesDiabetesInput",
                                  value: yesDiabetesInput,
                                })
                              }
                              disabled={
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "yesDiabetesInput")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                          ...
                          <td className="col-sm-3">
                            ...
                            <button
                              ...
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "hypertensionComorbidities",
                                  value: hypertensionComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setHypertensionAfter(e.target.value)
                                }
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Hypertension Prior To",
                                    fControlName: "hypertensionAfter",
                                    value: hypertensionAfter,
                                  })
                                }
                                value={"Prior to"}
                                type="radio"
                            ...
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Hypertension input",
                                  fControlName: "yesHyperTensionInput",
                                  value: yesHyperTensionInput,
                                })
                              }
                              disabled={
                          ...
                          <td className="col-sm-3">
                            ...
                            <button
                              ...
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "dyslipidemiaComorbidities",
                                  value: dyslipidemiaComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setDyslipidemiaAfter(e.target.value)
                                }
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Dyslipidemia Prior To",
                                    fControlName: "dysliAfter",
                                    value: dysliAfter,
                                  })
                                }
                                value={"Prior to"}
                              ...
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist("section5", "dysliAfter")
                                    ? "cBtn cExists"
                                    : "cBtn cNExists"
                                }
                                onClick={(e) =>
                            ...
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Dyslipidemia input",
                                  fControlName: "yesDyslipidemiaInput",
                                  value: yesDyslipidemiaInput,
                                })
                              }
                              disabled={
                        ...
                        <tr>
                          <td className="col-sm-3">
                            ...
                            <button
                              ...
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "coronaryComorbidities",
                                  value: coronaryComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setCoronaryAfter(e.target.value)
                                }
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Coronary Artery Disease Prior To",
                                    fControlName: "coronaryAfter",
                                    value: coronaryAfter,
                                  })
                                }
                                value={"Prior to"}
                              ...
                              <input
                                ...
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Coronary Artery Disease After",
                                    fControlName: "coronaryAfter",
                                    value: coronaryAfter,
                                  })
                                }
                              ...
                              <input
                                ...
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Coronary Artery Disease NAV",
                                    fControlName: "coronaryAfter",
                                    value: coronaryAfter,
                                  })
                                }
                              ...
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist("section5", "coronaryAfter")
                                    ? "cBtn cExists"
                                    : "cBtn cNExists"
                                }
                                onClick={(e) =>
                          ...
                          <td className="col-sm-2">
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Coronary Artery Disease input",
                                  fControlName: "yesCoronaryInput",
                                  value: yesCoronaryInput,
                                })
                              }
                              disabled={
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "yesCoronaryInput")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                        ...
                        <tr>
                          <td className="col-sm-3">
                            ...
                            <button
                              ...
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "peripheralComorbidities",
                                  value: peripheralComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                            ...
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Peripheral Vascular Disease",
                                  fControlName: "peripheralComorbidities",
                                  value: peripheralComorbidities,
                                })
                              }
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setPeripheralAfter(e.target.value)
                                }
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName:
                                      "Peripheral Vascular Disease Prior To",
                                    fControlName: "peripheralAfter",
                                    value: peripheralAfter,
                                  })
                                }
                                value={"Prior to"}
                                type="radio"
                              ...
                              <input
                                ...
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Peripheral Vascular Disease After",
                                    fControlName: "peripheralAfter",
                                    value: peripheralAfter,
                                  })
                                }
                              ...
                              <input
                                ...
                                onBlur={() =>
                                  handleAuditDetails({
                                    id: 5,
                                    name: "Comorbidities",
                                    fName: "Peripheral Vascular Disease NAV",
                                    fControlName: "peripheralAfter",
                                    value: peripheralAfter,
                                  })
                                }
                              ...
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist("section5", "peripheralAfter")
                                    ? "cBtn cExists"
                                    : "cBtn cNExists"
                                }
                                onClick={(e) =>
                          ...
                          <td className="col-sm-2">
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 5,
                                  name: "Comorbidities",
                                  fName: "Peripheral Vascular Disease input",
                                  fControlName: "yesPeripheralInput",
                                  value: yesPeripheralInput,
                                })
                              }
                              disabled={
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "yesPeripheralInput")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                        ...
                        <tr>
                          <td className="col-sm-3">
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "hivComorbidities")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "hivComorbidities",
                                  value: hivComorbidities,
                                  section: "section5",
                                })
                              }
                            ></button>
                          ...
                          <td className="col-sm-4">
                            <div>
                              ...
                              <button
                                type="btn btn-primary"
                                className={
                                  isCommentExist("section5", "hivAfter")
                                    ? "cBtn cExists"
                                    : "cBtn cNExists"
                                }
                                onClick={(e) =>
                          ...
                          <td className="col-sm-2">
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "yesHivInput")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                        ...
                        <tr>
                          <td className="col-sm-3">
                            ...
                            <button
                              type="btn btn-primary"
                              className={
                                isCommentExist("section5", "nonLiverCancer")
                                  ? "cBtn cExists"
                                  : "cBtn cNExists"
                              }
                              onClick={(e) =>
                                handleComments({
                                  e,
                                  fControlName: "nonLiverCancer",
                                  value: nonLiverCancer,
                                  section: "section5",
                                })
                              }
                            ></button>
                      ...
                      <div className="col-sm-4">
                        <label htmlFor="if-yes-location" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section5", "yesLocationSiteValue")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "yesLocationSiteValue",
                        ...
                        <textarea
                          ...
                          id="if-yes-location"
                          disabled={
                            nonLiverCancer !== "Yes" || role === "ROLE_REVIEWER"
                          }
                          value={yesLocationSiteValue}
                          onChange={(e) =>
                            setYesLocationSiteValue(e.target.value)
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 5,
                      ...
                      <div className="col-sm-4">
                        <label htmlFor="if-yes-stage" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section5", "yesStageValue")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-4">
                        <label htmlFor="if-yes-diagnosis" className="label-txt">
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section5", "yesYearOfDiagnosis")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "yesYearOfDiagnosis",
                    ...
                    <div
                      className="container-width-for-chronic"
                      style={{ marginTop: 20 }}
                    >
                      <label className="label-txt">
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "alcoholConsumptionValue",
                      ...
                      <div className="chronic-mittal">
                          ...
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 5,
                                name: "Comorbidities",
                                fName: "Alcohol Consumption / Abuse",
                                fControlName: "alcoholConsumptionValue",
                                value: alcoholConsumptionValue,
                              })
                            }
                        ...
                        <div>
                          ...
                          <label htmlFor="alcohol-consumption-history">
                            History of more than 3 drinks per day for men or
                        ...
                        <div>
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 5,
                                name: "Comorbidities",
                                fName: "Alcohol Consumption / Abuse Sub",
                                fControlName: "alcoholConsumptionValueSub",
                                value: alcoholConsumptionValueSub,
                              })
                            }
                            onChange={(e) =>
                              setAlcoholConsumptionValueSub(e.target.value)
                          ...
                          <label htmlFor="alcohol-consumption-document">
                            Documentation of alcoholism/alcoholic abuse in
                          ...
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 5,
                                name: "Comorbidities",
                                fName: "Alcohol Consumption / Abuse Unknown",
                                fControlName: "alcoholConsumptionValue",
                                value: alcoholConsumptionValue,
                              })
                            }
                      ...
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "diagnosisInformationValue",
                              value: diagnosisInformationValue,
                              section: "section6",
                            })
                          }
                        ></button>
                      ...
                      <div className="chronic-mittal">
                        <div style={{ display: "inline-flex" }}>
                          <input
                            ...
                            checked={diagnosisInformationValue.includes(
                            ...
                            onChange={(e) => {
                              ...
                              if (diagnosisInformationValue.includes(s)) {
                                updatedValues =
                                  diagnosisInformationValue.filter(
                                    (item) => item !== s
                                  );
                              } else {
                                updatedValues = [
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 6,
                                name: "HCC Diagnosis Information",
                                fName: "Method of Diagnosis",
                                fControlName: "diagnosisInformationValue",
                                value: diagnosisInformationValue,
                              })
                            }
                        ...
                        <div style={{ display: "inline-flex" }}>
                          ...
                          />
                          <label
                            htmlFor="diagnosis-information-other"
                            style={{ marginTop: 10 }}
                          >
                            Other(specify)
                          </label>
                          <textarea
                            ...
                            onChange={(e) =>
                              sethccDiagnosisInfo(e.target.value)
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 6,
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section6", "typeOfImagine")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                    ...
                    <div className="col-sm-8">
                      <div style={{ display: "inline-flex" }}>
                        <input
                          ...
                          disabled={
                            role === "ROLE_REVIEWER" ||
                            !diagnosisInformationValue.includes("Imaging")
                          }
                          className="gap"
                          required
                        ...
                        <textarea
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              ...
                              name: "HCC Diagnosis Information",
                              fName: "Type of Imaging",
                              fControlName: "typeOfImagineText",
                              value: typeOfImagineText,
                            })
                          }
                          required={typeOfImagine === "Other"}
                      ...
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "hccDiagnosisImagingDate",
                    ...
                    >
                      <div className="container-width">
                        <input
                          ...
                          disabled={
                            (hccDiagnosisImagingUnkown &&
                              hccDiagnosisImagingUnkown[0] === "Unknown") ||
                            role === "ROLE_REVIEWER" ||
                            !diagnosisInformationValue.includes("Imaging")
                          }
                          onChange={(e) => {
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 6,
                              name: "HCC Diagnosis Information",
                              fName: "Date of Imaging(first) Found",
                              fControlName: "hccDiagnosisImagingDate",
                              value: hccDiagnosisImagingDate,
                            })
                          }
                      ...
                      <div>
                        <input
                          ...
                          id="hccdate-imaging"
                          checked={hccDiagnosisImagingUnkown.includes(
                            "Unknown"
                          )}
                          onChange={() =>
                            handleDiagnosisImagingUnknown("Unknown")
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 6,
                              name: "HCC Diagnosis Information",
                              fName: "Date of Imaging(first) Found",
                              fControlName: "hccDiagnosisImagingUnkown",
                              value: hccDiagnosisImagingUnkown,
                            })
                          }
                          className="date-tissue hcc-unknown"
                          type="checkbox"
                        />
                        <label htmlFor="hccdate-imaging" className="mL5">
                          Unknown
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section6", "hccDiagnosisTissueDate")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "hccDiagnosisTissueDate",
                    ...
                    >
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 6,
                              name: "HCC Diagnosis Information",
                              fName: "Date of Tissue Diagnosis",
                              fControlName: "hccDiagnosisTissueDate",
                              value: hccDiagnosisTissueDate,
                            })
                          }
                      ...
                      <div>
                        <input
                          ...
                          id="hccdate-tissue"
                          checked={hccDiagnosisTissueUnknown.includes(
                            "Unknown"
                          )}
                          onChange={() =>
                            handleDiagnosisTissueUnknown("Unknown")
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 6,
                              name: "HCC Diagnosis Information",
                              fName: "Date of Tissue Diagnosis",
                              fControlName: "hccDiagnosisTissueUnknown",
                              value: hccDiagnosisTissueUnknown,
                            })
                          }
                          className="date-tissue hcc-unknown"
                          type="checkbox"
                        />
                        <label htmlFor="hccdate-tissue" className="mL5">
                          Unknown
                        </label>
                      </div>
                    </div>
              ...
              <Fade>
                <div className="card p-3">
                  <div className="container-width" style={{ width: "100%" }}>
                    <div className="col-sm-4">
                      <label
                        htmlFor="large-turmor-size"
                        className="label-txt"
                        style={{ fontWeight: 600 }}
                      >
                        Largest tumor size/diameter (if multiple nodules,
                        include only the largest)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "largeTurmorValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 7,
                            name: "HCC Staging",
                            fName: "Largest Tumor Size/Diameter",
                            fControlName: "largeTurmorValue",
                            value: largeTurmorValue,
                          })
                        }
                  ...
                  <div className="container-widthd-comorbidities">
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        T(Primary Tumor) <br /> (as per Current TNM HCC
                        classfication)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "tPrimaryValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                  ...
                  <div className="container-width" style={{ width: "100%" }}>
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        N(Regional Lymph Nodes) <br /> (as per Current TNM HCC
                        Classfication)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "nRegionalValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "nRegionalValue",
                              value: nRegionalValue,
                              section: "section7",
                            })
                          }
                        ></button>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            ...
                            name: "HCC Staging",
                            fName:
                              "N(Regional Lymph Nodes)(as per Current TNM HCC Classfication)",
                            fControlName: "nRegionalValue",
                            value: nRegionalValue,
                          })
                        }
                  ...
                  <div className="container-width" style={{ width: "100%" }}>
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        M(Distant Metastasis) <br /> (as per Current TNM HCC
                        Classfication)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "mRegionalValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "mRegionalValue",
                              value: mRegionalValue,
                              section: "section7",
                            })
                          }
                        ></button>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            ...
                            name: "HCC Staging",
                            fName:
                              "M(Distant Metastasis)(as per Current TNM HCC Classfication)",
                            fControlName: "mRegionalValue",
                            value: mRegionalValue,
                          })
                        }
                  ...
                  <div className="container-width-for-chronic">
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        Anatomic Stage <br /> (as per Current TNM HCC
                        Classfication)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "anatomicStageTNM")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "anatomicStageTNM",
                              value: anatomicStageTNM,
                              section: "section7",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "tumorDiffValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "tumorDiffValue",
                              value: tumorDiffValue,
                              section: "section7",
                            })
                          }
                        ></button>
                  ...
                  <div className="d-subject">
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ECOG performance score (or Karnofsky equivalent) <br />{" "}
                        (as per Current ECOG performance scale if applicable)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "ecogperformace")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "ecogperformace",
                              value: ecogperformace,
                              section: "section7",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-8">
                      <div className="row">
                        ...
                        <div className="col-sm-6 inlineFlex">
                          ...
                          />
                          <label
                            htmlFor="ecog-performance-0-4-20"
                            className="mt-2"
                          >
                            4 (KPS 10 or 20)
                          </label>
                        ...
                        <div className="col-sm-6 inlineFlex">
                          ...
                          />
                          <label
                            htmlFor="ecog-performance-3-dead"
                            className="mt-2"
                          >
                            5 (KPS 0 = dead)
                          </label>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "tumorStageValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "tumorStageValue",
                              value: tumorStageValue,
                              section: "section7",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "typeOfVascular")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "typeOfVascular",
                              value: typeOfVascular,
                              section: "section7",
                            })
                          }
                        ></button>
                  ...
                  <div className="container-width-for-chronic">
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        Is Microvascular invasion present on histology? <br />{" "}
                        (fill only if macrovascular invasion is absent)
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "microvascularInvasion")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "microvascularInvasion",
                              value: microvascularInvasion,
                              section: "section7",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "tumorWithinMilan")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "tumorWithinMilan",
                              value: tumorWithinMilan,
                              section: "section7",
                            })
                          }
                        ></button>
                      ...
                      <div className="d-subject">
                        <div className="chronic-mittal">
                          <div className="tumor-stage1">
                            <input
                              ...
                              onBlur={() =>
                                handleAuditDetails({
                                  id: 7,
                                  name: "HCC Staging",
                                  fName: "Tumor Within Milan Criteria",
                                  fControlName: "tumorWithinMilan",
                                  value: tumorWithinMilan,
                                })
                              }
                            ...
                            <label
                              htmlFor="tumor-widthin-milan-yes"
                              className="mL10"
                            >
                              Yes (Single lesion 5 cm or less, OR up to 3
                              separate lesions none larger than 3 cm, AND
                              <br />
                          ...
                          <div className="tumor-stage1">
                            ...
                            />
                            <label
                              htmlFor="tumor-widthin-milan-no"
                              className="mL10"
                            >
                          ...
                          <div className="tumor-stage1">
                            ...
                            />
                            <label
                              htmlFor="tumor-widthin-milan-notenough"
                              className="mL10"
                            >
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "childPughClassfication")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "childPughClassfication",
                              value: childPughClassfication,
                              section: "section7",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section7", "barcelonaClinic")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "barcelonaClinic",
                              value: barcelonaClinic,
                              section: "section7",
                            })
                          }
                        ></button>
                        ...
                        <div className="d-subject">
                          <div className="chronic-mittal">
                            ...
                            <div className="tumor-stage1">
                              ...
                              />
                              <label
                                htmlFor="barcelona-clinic-stagea"
                                className="mL10 mt-2"
                              >
                            ...
                            <div className="tumor-stage1">
                              ...
                              />
                              <label
                                htmlFor="barcelona-clinic-stageb"
                                className="mL10 mt-2"
                              >
                            ...
                            <div className="tumor-stage1">
                              ...
                              />
                              <label
                                htmlFor="barcelona-clinic-stagec"
                                className="mL10 mt-2"
                              >
                            ...
                            <div className="tumor-stage1">
                              ...
                              />
                              <label
                                htmlFor="barcelona-clinic-stage-not"
                                className="mL10 mt-2"
                              >
                                Not Available/Cannot be Calculated
                              </label>
                ...
                <Fade>
                  <div className="card p-3">
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section8", "fattyLiverCLD")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 8,
                              name: "Chronic Liver Disease (CLD)Etiology",
                              fName: "Is Fatty Liver Present?",
                              fControlName: "fattyLiverCLD",
                              value: fattyLiverCLD,
                            })
                          }
                          ...
                          type="radio"
                        />
                        <label className="cld-fatty" htmlFor="cld-yes">
                          Yes
                        </label>
                        <input
                          className="screen-m"
                          ...
                          type="radio"
                        />
                        <label className="cld-fatty" htmlFor="cld-no">
                          No
                        </label>
                        <input
                          className="screen-m"
                    ...
                    <div className="container-width-for-chronic">
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section8", "fattyLiverRadioLast")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "fattyLiverRadioLast",
                                value: fattyLiverRadioLast,
                                section: "section8",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          onChange={(e) =>
                            setFattyLiverRadioLast(e.target.value)
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 8,
                              name: "Chronic Liver Disease (CLD)Etiology",
                              fName: "Fatty Liver Diagnostic Modality",
                              fControlName: "fattyLiverRadioLast",
                              value: fattyLiverRadioLast,
                            })
                          }
                    ...
                    <div className="container-width" style={{ width: "100%" }}>
                      <div className="col-sm-4">
                        <label
                          htmlFor="fatty-liver-diagnostic"
                          className="label-txt"
                          style={{ fontWeight: 600 }}
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "fattyLiverDiagnosticFreeText",
                      ...
                      <textarea
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 8,
                            name: "Chronic Liver Disease (CLD)Etiology",
                            fName: "Fatty Liver Diagnostic Modality Free Text",
                            fControlName: "fattyLiverDiagnosticFreeText",
                            value: fattyLiverDiagnosticFreeText,
                          })
                        }
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section8", "cirrhosisStatusValue")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "cirrhosisStatusValue",
                                value: cirrhosisStatusValue,
                                section: "section8",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section8", "mittalCriteriaValue")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "mittalCriteriaValue",
                                value: mittalCriteriaValue,
                                section: "section8",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <div className="mittal-bottom">
                          <input
                            ...
                            onChange={(e) =>
                              setMittalCriteriaValue(e.target.value)
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 8,
                                name: "Chronic Liver Disease (CLD)Etiology",
                                fName: "Mittals Criteria",
                                fControlName: "mittalCriteriaValue",
                                value: mittalCriteriaValue,
                              })
                            }
                        ...
                        <div className="mittal-bottom inlineFlex">
                          ...
                          />
                          <label
                            htmlFor="mital-criteria-b"
                            className="mL10 mt-2"
                          >
                            (b) Level 2 Evidence (high probability) of no
                            cirrhosis, which lacks histology but is based on
                            imaging and laboratory criteria
                          </label>
                        </div>
                        <div className="mittal-bottom inlineFlex">
                          <input
                          ...
                          />
                          <label
                            htmlFor="mital-criteria-c"
                            className="mL10 mt-2"
                          >
                            (c) Confirmed Cirrhosis, Which is based on
                            Histological, Imaging, Clinical or Laboratory
                            Criteria
                          </label>
                        </div>
                        <div className="mittal-bottom inlineFlex">
                          ...
                          />
                          <label
                            htmlFor="mital-criteria-d"
                            className="mL10 mt-2"
                          >
                            (d) *Unclassified (insufficient data to classify
                            into any of the above cirrhosis categories)
                          </label>
                        </div>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "underlyingEtiologyValue",
                                value: underlyingEtiologyValue,
                                section: "section8",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        ...
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="underlying-alcohol" className="mL5">
                            Alcohol
                          </label>
                        </div>
                        <div className="mittal-bottom">
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="underlying-hemochromatosis"
                            className="mL5"
                          >
                            Hemochromatosis
                          </label>
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="underlying-other-etiologies"
                            className="mL5"
                          >
                            Other etiologies
                          </label>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "etiologyCirrhosisFreeValue",
                      ...
                      <textarea
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 8,
                            name: "Chronic Liver Disease (CLD)Etiology",
                            fName: "Etiology of Cirrhosis Free Text",
                            fControlName: "etiologyCirrhosisFreeValue",
                            value: etiologyCirrhosisFreeValue,
                          })
                        }
                    ...
                    <div className="container-width-for-chronic">
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <br /> time of HCC diagnosis)
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section8", "complicationCLD")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-8">
                        ...
                        <div className="mittal-bottom">
                          <input
                            ...
                            onChange={() =>
                              handleComplicationCLD("Encephalopathy")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 8,
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="complications-no-complication"
                            className="mL5"
                          >
                            No complications occurred
                          </label>
                        ...
                        <div className="mittal-bottom inlineFlex">
                          ...
                          />
                          <label
                            htmlFor="complications-information"
                            className="mL5"
                          >
                            Information not availabel or not applicable (Patient
                            not cirrhosis)
                          </label>
                        </div>
                        <div className="mittal-bottom">
              ...
              <Fade>
                <div className="card p-3">
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section9", "hccOutcomeValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "hccOutcomeValue",
                              value: hccOutcomeValue,
                              section: "section9",
                            })
                          }
                        ></button>
                    ...
                    <div className="cols-m-8">
                      <div className="mittal-bottom">
                        <input
                          ...
                          type="checkbox"
                        />
                        <label htmlFor="hcc-resection" className="mL5">
                          Resection
                        </label>
                      </div>
                      <div className="mittal-bottom">
                        ...
                        />
                        <label
                          htmlFor="hcc-liver-transplatation"
                          className="mL5"
                        >
                          Liver Transplantation
                        </label>
                      ...
                      <div className="mittal-bottom">
                        <input
                          ...
                          type="checkbox"
                        />
                        <label htmlFor="hcc-sorafenib" className="mL5">
                          Sorafenib
                        </label>
                      </div>
                      <div className="mittal-bottom">
                        <input
                          ...
                          onChange={() =>
                            handleHccOutComeValue("Radiation(SBRT)")
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 9,
                          ...
                          type="checkbox"
                        />
                        <label htmlFor="hcc-radiation" className="mL5">
                          Radiation(SBRT)
                        </label>
                      </div>
                      <div className="mittal-bottom">
                        <input
                          ...
                          type="checkbox"
                        />
                        <label htmlFor="hcc-rfa" className="mL5">
                          RFA Ablation
                        </label>
                      </div>
                      <div className="mittal-bottom">
                      ...
                      <div className="mittal-bottom">
                        <input
                          ...
                          type="checkbox"
                        />
                        <label htmlFor="hcc-microwave" className="mL5">
                          Microwave ablation
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                      ...
                      >
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section9", "treamentModalitiesHCC")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "treamentModalitiesHCC",
                    ...
                    <div className="container-width-for-chronic">
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section9", "resectionPerformed")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "resectionPerformed",
                                value: resectionPerformed,
                                section: "section9",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                          ...
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 9,
                                name: "HCC Outcome",
                                fName: "Stage of Fibrosis in Background Liver",
                                fControlName: "resectionPerformed",
                                value: resectionPerformed,
                              })
                            }
                            ...
                            type="radio"
                          />
                          <label htmlFor="hcc-performed-none" className="mL5">
                            None/F0
                          </label>
                        </div>
                        <div className="mittal-bottom">
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="hcc-performed-moderate"
                            className="mL5"
                          >
                            Moderate/Stage 2/F2
                          </label>
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="hcc-performed-bridiging"
                            className="mL5"
                          >
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="hcc-performed-cirrhosis"
                            className="mL5"
                          >
                    ...
                    <div className="container-width-for-chronic">
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section9", "liverTransplantValue")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "liverTransplantValue",
                                value: liverTransplantValue,
                                section: "section9",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                          ...
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                id: 9,
                                name: "HCC Outcome",
                                fName: "Stage of Fibrosis in Explanted Liver",
                                fControlName: "liverTransplantValue",
                                value: liverTransplantValue,
                              })
                            }
                            ...
                            type="radio"
                          />
                          <label htmlFor="liver-transplant" className="mL5">
                            None/F0
                          </label>
                        </div>
                        <div className="mittal-bottom">
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="liver-transplant-moderate"
                            className="mL5"
                          >
                            Moderate/Stage 2/F2
                          </label>
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="liver-transplant-bridiging"
                            className="mL5"
                          >
                            Bridiging Fibrosis/Stage 3F3
                          </label>
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="liver-transplant-cirrhosis"
                            className="mL5"
                          >
                            Cirrhosis/Stage 4/F4
                          </label>
                        ...
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="liver-transplant-unknown"
                            className="mL5"
                          >
                            Unknown
                          </label>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section9", "recurrenceValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                    ...
                    <div className="container-width" style={{ width: "100%" }}>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "selectedDateOfFirstRecurrence",
                      ...
                      <div className="col-sm-3">
                        <input
                          ...
                          disabled={
                            (recurrenceValue !== "Yes once" &&
                              recurrenceValue !== "Yes more than once") ||
                            role === "ROLE_REVIEWER"
                          }
                          type="date"
                          value={selectedDateOfFirstRecurrence}
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 9,
                              name: "HCC Outcome",
                              fName: "Date of First Recurrence",
                              fControlName: "selectedDateOfFirstRecurrence",
                              value: selectedDateOfFirstRecurrence,
                            })
                          }
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section9", "survivalStatusValue")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "survivalStatusValue",
                              value: survivalStatusValue,
                              section: "section9",
                            })
                          }
                        ></button>
                    ...
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          type="btn btn-primary"
                          className={
                            isCommentExist("section9", "selectedDateOfDeath")
                              ? "cBtn cExists"
                              : "cBtn cNExists"
                          }
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "selectedDateOfDeath",
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            ...
                            name: "HCC Outcome",
                            fName: "Date of Death",
                            fControlName: "dateOfDeathUnknown",
                            value: dateOfDeathUnknown,
                          })
                        }
                  ...
                  >
                    <div className="col-sm-4">
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        Date of last contact (if patient is alive or dead but
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "selectedDateOfLastContact",
                    ...
                    <input
                      ...
                      onBlur={() =>
                        handleAuditDetails({
                          ...
                          fName:
                            "Date of Last Contact(if patient is alive or dead)",
                          fControlName: "lastContactUnknown",
                          value: lastContactUnknown,
                        })
                      }
                      className="chronicliver-ww1 mL5"
                      type="radio"
                      ...
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "selectedDateOfRecurrenceFree",
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 9,
                            name: "HCC Outcome",
                            fName: "Recurrence-free Survival(days)",
                            fControlName: "selectedDateOfRecurrenceFree",
                            value: selectedDateOfRecurrenceFree,
                          })
                        }
                      ...
                      <label className="label-txt" style={{ fontWeight: 600 }}>
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            handleComments({
                              e,
                              fControlName: "selectedDateOfOverallSurvival",
                  ...
                  <div>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section10", "screeningQuestion")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "screeningQuestion",
                      ...
                      <div className="col-sm-8">
                          ...
                          <input
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                ...
                                fName: "How was the HCC Diagnosed?",
                                fControlName: "screeningQuestion",
                                value: screeningQuestion,
                              })
                            }
                        ...
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="radio"
                          />
                          <label htmlFor="screen-question-other">
                            Other, If Others, Pls Specify
                          </label>
                          <textarea
                            onKeyDown={handleKeyPress}
                            maxLength={50}
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                ...
                                name: "Screening Question",
                                fName: "How was the HCC Diagnosed?",
                                fControlName: "screeningQuestionNa",
                                value: screeningQuestionNa,
                              })
                            }
                            className="form-control"
                    ...
                    >
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <br /> Found within 2 Years Before HCC diagnosis?
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section10", "screening2Years")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "screening2Years",
                                value: screening2Years,
                                section: "section10",
                              })
                            }
                          ></button>
                    ...
                    >
                      <div className="col-sm-4">
                        ...
                        >
                          Any Method of Screening
                          <br /> Found within 1 Year Before HCC diagnosis?
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section10", "screening1Year")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "screening1Year",
                                value: screening1Year,
                                section: "section10",
                              })
                            }
                          ></button>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              ...
                              name: "Screening Question",
                              fName:
                                "Any Method of Screening Found within 1 Year Before",
                              fControlName: "screening1Year",
                              value: screening1Year,
                            })
                          }
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section10", "methodOfScreening")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "methodOfScreening",
                                value: methodOfScreening,
                                section: "section10",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        ...
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="radio"
                          />
                          <label htmlFor="method-screening-un" className="mL5">
                            Unknown
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          ...
                          />
                          <label
                            htmlFor="method-screening-other"
                            className="mL5"
                          >
                            Other, If Others, Pls Specify
                          </label>
                          <textarea
                            ...
                            onBlur={() =>
                              handleAuditDetails({
                                ...
                                name: "Screening Question",
                                fName: "Method Of Screening ?",
                                fControlName: "methodOfScreeningTxt",
                                value: methodOfScreeningTxt,
                              })
                            }
                            rows={1}
                  ...
                  <div className="card p-3">
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "historyHIV")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "History of HIV",
                              fControlName: "historyHIV",
                              value: historyHIV,
                            })
                          }
                          ...
                          type="radio"
                        />
                        <label htmlFor="history-yes" className="mL5">
                          Yes
                        </label>
                        <input
                          onKeyDown={handleKeyPress}
                          ...
                          type="radio"
                        />
                        <label htmlFor="history-no" className="mL5">
                          No
                        </label>
                    ...
                    >
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "yearOfHIVHCC")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-2">
                        <input
                          ...
                          value={yearOfHIVHCC}
                          disabled={
                            historyHIV !== "Yes" || role === "ROLE_REVIEWER"
                          }
                          onChange={(e) => {
                            const inputValue = e.target.value;
                            if (/^\d{0,4}$/.test(inputValue)) {
                    ...
                    >
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "dateOfHIVDurationFrom",
                      ...
                      <div className="col-sm-8 inlineFlex">
                        ...
                        />
                        <label style={{ color: "black", marginLeft: "7px" }}>
                          (From year of diagnosis of HIV to year of diagnosis of
                          HCC)
                        </label>
                      </div>
                      {/* </div> */}
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "hivRNAHCC")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 11,
                            name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                            fName: "HIV RNA Level (most recent)",
                            fControlName: "hivRNAHCC",
                            value: hivRNAHCC,
                          })
                        }
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          If HIV RNA level is below
                          <br /> lower limit of detection, (Fill the following)
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "belowRadioHCC")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      >
                        <input
                          ...
                          checked={belowRadioHCC.includes(
                          ...
                          onChange={(e) => {
                            ...
                            if (belowRadioHCC.includes(e.target.value)) {
                              updatedValues = belowRadioHCC.filter(
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "hivCD4")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "CD4 (%) (Clusters of differentiation 4)",
                              fControlName: "hivCD4",
                              value: hivCD4,
                            })
                          }
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              ...
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName:
                                "CD4 (%) (Clusters of differentiation 4) NAV",
                              fControlName: "hivCD4Nav",
                              value: hivCD4Nav,
                            })
                          }
                          disabled={
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "hivAbsoluteCD4")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "Absolute CD4 (cells/uL) NAV",
                              fControlName: "hivAbsoluteCD4Nav",
                              value: hivAbsoluteCD4Nav,
                            })
                          }
                          type="radio"
                          id="nav-2"
                        />
                        <label htmlFor="nav-2" className="mL5">
                          NAV
                        </label>
                      </div>
                    </div>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "hivCD4CellCount")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "CD4 Cell Count Nadir (if known)",
                              fControlName: "hivCD4CellCount",
                              value: hivCD4CellCount,
                            })
                          }
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "CD4 Cell Count Nadir (if known) NAV",
                              fControlName: "hivCD4CellCountNav",
                              value: hivCD4CellCountNav,
                            })
                          }
                          type="radio"
                          id="nav-3"
                        />
                        <label htmlFor="nav-3" className="mL5">
                          NAV
                        </label>
                      </div>
                    </div>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "hivInitialHIV1")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "Initial HIV-1 RNA Level (if known)",
                              fControlName: "hivInitialHIV1",
                              value: hivInitialHIV1,
                            })
                          }
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "Initial HIV-1 RNA Level (if known) NAV",
                              fControlName: "hivInitialHIV1Nav",
                              value: hivInitialHIV1Nav,
                            })
                          }
                          type="radio"
                          id="nav-4"
                        />
                        <label htmlFor="nav-4" className="mL5">
                          NAV
                        </label>
                      </div>
                    </div>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section11", "maximumHIVRNA")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "Maximum HIV-1 RNA Level (if known)",
                              fControlName: "maximumHIVRNA",
                              value: maximumHIVRNA,
                            })
                          }
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 11,
                              name: "HIV-Specific Lab Data within 6 months of HCC diagnosis",
                              fName: "Maximum HIV-1 RNA Level (if known) NAV",
                              fControlName: "maximumHIVRNANav",
                              value: maximumHIVRNANav,
                            })
                          }
                          type="radio"
                          id="nav-5"
                        />
                        <label htmlFor="nav-5" className="mL5">
                          NAV
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="card p-3">
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "isDateHCVDiagnosis")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "isDateHCVDiagnosis",
                                value: isDateHCVDiagnosis,
                                section: "section12",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 12,
                              name: "Hepatitis C virus (HCV) data within 6 months of HCC diagnosis",
                              fName: "Is Date of HCV Diagnosis Known?",
                              fControlName: "isDateHCVDiagnosis",
                              value: isDateHCVDiagnosis,
                            })
                          }
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "dateOfHCVCVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Is HCV Viral Load Known
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "isHCViralCVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "isHCViralCVirus",
                                value: isHCViralCVirus,
                                section: "section12",
                              })
                            }
                          ></button>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "HCVviralTimeOfHCCDiagnosis",
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 12,
                              name: "Hepatitis C virus (HCV) data within 6 months of HCC diagnosis",
                              fName: "HCV Viral Load at Time of HCC Diagnosis",
                              fControlName: "HCVviralTimeOfHCCDiagnosis",
                              value: HCVviralTimeOfHCCDiagnosis,
                            })
                          }
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "hcvGenotype")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-8">
                        <div className="mittal-bottom">
                          <input
                            ...
                            // value={"1a"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("1a")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                          ...
                          <input
                            ...
                            // value={"1b"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("1b")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                        ...
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            className="mL5"
                          />
                          <label htmlFor="1 unknown" style={{ marginLeft: 5 }}>
                            1 Unknown
                          </label>
                          {/* </div>
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            // value={"2"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("2")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                        ...
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            // value={"3"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("3")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                        ...
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            // value={"4"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("4")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                        ...
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            // value={"5"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("5")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                        ...
                        <div className="mittal-bottom"> */}
                          <input
                            ...
                            // value={"6"}
                            onChange={() =>
                              handleHCVGenotypeMultiselection("6")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Was HCV Treatment Received Before or After initial HCC
                          diagnosis?
                          <button
                            type="btn btn-primary"
                            className={
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "wasHCVReceivedBeforeAfter",
                                value: wasHCVReceivedBeforeAfter,
                                section: "section12",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        ...
                        <div>
                          <input
                            ...
                            checked={
                              wasHCVReceivedBeforeAfter === "Not applicable"
                            }
                            value={"Not applicable"}
                            onChange={(e) =>
                              setWasHCVReceivedBeforeAfter(e.target.value)
                            ...
                            type="radio"
                          />
                          <label htmlFor="Not applicablewas">
                            Not Applicable
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "hcvTreatmentCVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "hcvTreatmentCVirus",
                                value: hcvTreatmentCVirus,
                                section: "section12",
                              })
                            }
                          ></button>
                      ...
                      <div className="chronic-mittal">
                        ...
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="hcv-protease" className="mL5">
                            Protease Inhibitor
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="hcv-peg" className="mL5">
                            Peg Interferon
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            // value={"Ribavirin"}
                            onChange={() =>
                              handleHCVTreatmentCVirus("Ribavirin")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 12,
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="hcv-ribavirin" className="mL5">
                            Ribavirin
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="hcv-interferon" className="mL5">
                            Interferon Alpha
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="hcv-unknown" className="mL5">
                            Unknown
                          </label>
                        </div>
                        <div className="mittal-bottom">
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          When was HCV Treated (year)
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "hcvTreatedYear")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 12,
                            name: "Hepatitis C virus (HCV) data within 6 months of HCC diagnosis",
                            fName: "When was HCV Treated (year)",
                            fControlName: "hcvTreatedYear",
                            value: hcvTreatedYear,
                          })
                        }
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "hcvViralLoadAfterTreatment",
                                value: hcvViralLoadAfterTreatment,
                                section: "section12",
                              })
                            }
                          ></button>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 12,
                              name: "Hepatitis C virus (HCV) data within 6 months of HCC diagnosis",
                              fName: "Is HCV Viral Load after Treatment Known?",
                              fControlName: "hcvViralLoadAfterTreatment",
                              value: hcvViralLoadAfterTreatment,
                            })
                          }
                    ...
                    >
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "hcvPostTreatment")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <input
                        ...
                        disabled={
                          hcvViralLoadAfterTreatment !== "Yes" ||
                          role === "ROLE_REVIEWER"
                        }
                        className="form-control"
                        type="text"
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 12,
                            name: "Hepatitis C virus (HCV) data within 6 months of HCC diagnosis",
                            fName: "HCV Viral Load Post Treatment",
                            fControlName: "hcvPostTreatment",
                            value: hcvPostTreatment,
                          })
                        }
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Sustained virological response (SVR) after HCV
                          treatment (undetectable HCV RNA 12 weeks after
                          completion of treatment)
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "sustainedHCV")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section12", "yearSVRHCV")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                  ...
                  <div className="card p-3">
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section13", "isDateHBVDiagnosis")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "isDateHBVDiagnosis",
                                value: isDateHBVDiagnosis,
                                section: "section13",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 13,
                              name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                              fName: "Is Date of HBV diagnosis Known?",
                              fControlName: "isDateHBVDiagnosis",
                              value: isDateHBVDiagnosis,
                            })
                          }
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Date of HBV Diagnosis
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section13", "dateOfHBVBVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Is HBV Viral Load Known
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section13", "isHBViralBVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "isHBViralBVirus",
                                value: isHBViralBVirus,
                                section: "section13",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        ...
                        <input
                          ...
                          type="radio"
                        />
                        <label htmlFor="is HBV viral load knownUnknown">
                          Unknown
                        </label>
                      </div>
                    </div>
                    ...
                    >
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "HBVviralTimeOfHCCDiagnosis",
                      ...
                      <input
                        onKeyDown={handleKeyPress}
                        disabled={
                          isHBViralBVirus !== "Yes" || role === "ROLE_REVIEWER"
                        }
                        value={HBVviralTimeOfHCCDiagnosis}
                        onChange={(e) => {
                          const inputValue = e.target.value;
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 13,
                            name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                            fName: "HBV Viral Load at Time of HCC Diagnosis",
                            fControlName: "HBVviralTimeOfHCCDiagnosis",
                            value: HBVviralTimeOfHCCDiagnosis,
                          })
                        }
                    ...
                    >
                      <div className="col-sm-4">
                        <label
                          ...
                          style={{ fontWeight: 600 }}
                        >
                          Was HBV treatment received before or after initial HCC
                          diagnosis?
                          <button
                            type="btn btn-primary"
                            className={
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "wasHBVReceivedBeforeAfter",
                                value: wasHBVReceivedBeforeAfter,
                                section: "section13",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <input
                          ...
                          value={"Before"}
                          onChange={(e) =>
                            setWasHBVReceivedBeforeAfter(e.target.value)
                          }
                          onBlur={() =>
                            handleAuditDetails({
                              id: 13,
                        ...
                        <input
                          ...
                          disabled={role === "ROLE_REVIEWER"}
                          checked={
                            wasHBVReceivedBeforeAfter === "Not applicable"
                          }
                          value={"Not applicable"}
                          onChange={(e) =>
                            setWasHBVReceivedBeforeAfter(e.target.value)
                      ...
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section13", "hcvTreatmentBVirus")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "hcvTreatmentBVirus",
                                value: hcvTreatmentBVirus,
                                section: "section13",
                              })
                            }
                          ></button>
                      ...
                      <div className="col-sm-8">
                        <div className="mittal-bottom">
                          <input
                            ...
                            // value={"Lamivudine"}
                            onChange={() =>
                              handleHCVTreatmentBVirus("Lamivudine")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 13,
                                name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                                fName: "HBV Treatment Type",
                                fControlName: "hcvTreatmentBVirus",
                                value: hcvTreatmentBVirus,
                              })
                            }
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="lamivudineHcv" className="mL5">
                            Lamivudine
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            // value={"Tenofovir"}
                            onChange={() =>
                              handleHCVTreatmentBVirus("Tenofovir")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 13,
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="tenofovirHcv" className="mL5">
                            Tenofovir
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            // value={"Entecavir"}
                            onChange={() =>
                              handleHCVTreatmentBVirus("Entecavir")
                            }
                            onBlur={() =>
                              handleAuditDetails({
                                id: 13,
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="entecavirHcv" className="mL5">
                            Entecavir
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="enterferonHcv" className="mL5">
                            Interferon Alpha
                          </label>
                        </div>
                        <div className="mittal-bottom">
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="unknownHcv" className="mL5">
                            Unknown
                          </label>
                        </div>
                        <div className="mittal-bottom">
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "dateOfHBVTreatmentYear",
                      ...
                      <input
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 13,
                            name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                            fName: "When was HBV Treated (year)",
                            fControlName: "dateOfHBVTreatmentYear",
                            value: dateOfHBVTreatmentYear,
                          })
                        }
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) =>
                              handleComments({
                                e,
                                fControlName: "hbvViralLoadAfterTreatment",
                                value: hbvViralLoadAfterTreatment,
                                section: "section13",
                              })
                            }
                          ></button>
                        ...
                        <input
                          ...
                          onBlur={() =>
                            handleAuditDetails({
                              id: 13,
                              name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                              fName: "Is HBV Viral Load after Treatment Known?",
                              fControlName: "hbvViralLoadAfterTreatment",
                              value: hbvViralLoadAfterTreatment,
                            })
                          }
                    ...
                    >
                      <div className="col-sm-4">
                        ...
                        >
                          ...
                          <button
                            type="btn btn-primary"
                            className={
                              isCommentExist("section13", "hbvPostTreatment")
                                ? "cBtn cExists"
                                : "cBtn cNExists"
                            }
                            onClick={(e) =>
                      ...
                      <input
                        ...
                        disabled={
                          hbvViralLoadAfterTreatment !== "Yes" ||
                          role === "ROLE_REVIEWER"
                        }
                        ...
                        onBlur={() =>
                          handleAuditDetails({
                            id: 13,
                            name: "Hepatitis B virus (HBV) data within 6 months of HCC diagnosis",
                            fName: "HBV Viral Load Post Treatment",
                            fControlName: "hbvPostTreatment",
                            value: hbvPostTreatment,
                          })
                        }
                ...
                <div className="card p-3">
                  <div className="row">
                    ...
                    <div className="col-sm-3">
                      ...
                      <div>
                        <span>
                          {moment(createdOn, "YYYY-MM-DD HH:mm:ss").format(
                    ...
                    <div className="col-sm-3">
                      ...
                      <div>
                        <span>
                          {moment(changedOn, "YYYY-MM-DD HH:mm:ss").format(
                            "MMMM Do YYYY, h:mm:ss a"
                          )}
                        </span>
                      </div>
